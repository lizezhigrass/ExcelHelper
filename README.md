...
[English Documentation](README.md) | [中文说明 (Chinese Version)](README_ZH.md)
...
6. **Auto System Locale Sensing & Persistence**  
   Senses the active system language on start (defaults to English in non-Chinese environments) and supports manual overrides ("Auto", "简体中文", "English") in Settings, persisting values directly to `config.yaml`.
...
global:
  ...
  language: en                  # Display language: auto | zh (Chinese) | en (English)
```
